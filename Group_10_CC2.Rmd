...
1. **Frida Liveus** - 20629008
    + [BIOL343](https://github.com/frli4243/BIOL343)

2. **Daniella Briones** - 20396880
    + [BIOL343_CC](https://github.com/dbrionesgarcia/BIOL343_CC)

3. **Cecilia Stroz** - 20418105
    + [BIOL343_CC](https://github.com/ceciliastroz/BIOL343_CC)

4. **Yashodi Ambanwala** - 20396308
    + [BIOL343_CC](https://github.com/YashodiNA/BIOL343_CC)

5. **Mayher Kanwal** - 20549156
    + [BIOL343_CC](https://github.com/mayherkanwal/BIOL343_CC)
...
----------------|-------------------|------
population_type | Asexual or sexual |
ovary_width     | Width of ovary    | mm
ovary_height    | Height of ovary   | mm
flower_number   | Number of flowers |
...
cc1_data <- read.csv("./data/A1_Data_Excel_new (kopia).csv", sep = ";")
cc1_data <- cc1_data[1:46, 1:8]
ovary_area = cc1_data$ovary_width * cc1_data$ovary_height 
cc1_data$ovary_area <- ovary_area
```
...
The unit of ovary area is $mm^2$
...
```{r area-table, echo=F}
library(knitr)
kable(area_means, caption="Ovary area means by population type ")
```
...
library(ggplot2)
ggplot(aes(x=ovary_area), data=cc1_data) + geom_histogram(binwidth = 1, fill='pink') + facet_wrap(vars(population_type)) + labs(title="Ovary area", x="Ovary area mm^2", y="Count" ) + theme_classic()
...
![Solanum pimpinellifolium](./images/image_1.jpg):

Source: [Wikipedia](https://en.wikipedia.org/wiki/File:Botanisk_tidsskrift_(17645191178).jpg)
